...
.cmd(
	...
	not present.
	`,
	message: list_unspent,
	handler: ,
)

.cmd_descriptions(
  name: listunspent,
  min_confs: "the minimum number of confirmations for a utxo",
	max_confs: "the maximum number of confirmations for a utxo",
	unconfirmed_only: "when min_confs and max_confs are zero, " +
...
.cli listUnspent(ctx *cli.Context) error {
	var (
		minConfirms int64
		maxConfirms int64
		err         error
